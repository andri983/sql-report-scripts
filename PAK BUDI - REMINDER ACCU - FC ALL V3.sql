...
BEGIN
    ...
    INSERT INTO public.pra_his_all (
        ...
        nopolisi, namamember, notelp, idjenismember, namajenismember, statusaccuoff, statusaccuon, lasttrxaccu
    )
...
--create table public.pra_his_all_20251013 as
--select * from public.pra_his_all;
--select * from public.pra_his_all_20251013;

--INSERT INTO public.pra_his_all
--(transactiondate, reportdate, namacabang, kodetoko, nomortransaksi, nopolisi, namamember, notelp, idjenismember, namajenismember, statusaccuoff, lasttrxaccu)
--select * from public.pra_his_all_20251013;

-- POSTGRESQL
-- select * from public.pra_his_all_test definition;
-- select * from public.pra_his_all definition where reportdate=current_date;
-- Drop table
-- DROP TABLE public.pra_his_all;
CREATE TABLE public.pra_his_all (
	...
	statusaccuoff varchar(50) NULL,
	statusaccuon varchar(50) NULL,
	lasttrxaccu date NULL,
	CONSTRAINT pra_his_all_pk PRIMARY KEY (transactiondate, namacabang, nopolisi, kodetoko, nomortransaksi),
	CONSTRAINT pra_his_all_unique UNIQUE (transactiondate, kodetoko, nomortransaksi, nopolisi, reportdate)
);