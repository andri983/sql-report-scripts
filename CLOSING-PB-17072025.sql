...
Declare @iddc int	= 3			-- diisi berdasrakan iddc data yg akan ditarik
...
and iddc=3                -- diganti berdasarkan kodestatustoko yg akan ditarik datanya.
...
Declare @iddc int=3					 -- diganti berdasarkan iddc data yang ditarik
Declare @kodestatustoko varchar='R'
