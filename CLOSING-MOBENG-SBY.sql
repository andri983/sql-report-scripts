...
Declare @date1		date	='2026-08-01'   -- periode awal data
Declare @date2		date    ='2026-08-31'   -- periode akhir data
Declare @iddc		int     =2				-- isi sesuai iddc data yg akan ditarik
Declare @tahun		int     =2026
Declare @bulan		int     =08
...
Declare @date2		date='2026-08-31'   -- periode akhir data
Declare @tahun		int=2026	-- tahun penarikan Data
Declare @bulan		int=08	    -- bulan penarikan Data
Declare @iddc		int=2		-- iddc disesuaikan dgn iddc data yang ditarik
...
and bulan=08				-- input sesuai Bulan perikan data
...
--use MB_DC;
--use MB_DC_SBY;
Declare @date1 date = '2026-08-01'		-- diganti berdasarkan tanggal awal bulan penarikan data
Declare @date2 date = '2026-08-31'		-- diganti berdasarkan tanggal akhir bulan penarikan data
...
--GOOD, BOOK, BAD STOCK
/**************************************************************************************************/
Declare @date1 date	='2026-08-01'	-- diisi berdasarkan periode awal penarikan data
Declare @date2 date	='2026-08-31'	-- diisi berdasarkan periode Akhir penarikan data
