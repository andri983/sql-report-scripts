...
from smi_soh_toko_reg_byformula_view_5_fc(@date1,@date2,@idcabang,@kodestatustoko) as a
...
--GOOD STOCK DC
/**************************************************************************************************/
-- Query Tarik Data Inv. Movement DC Detail -- Mobeng

--USE [MB_DC_SBY]
--USE MB_DC
Declare @date1 date ='2025-06-01' -- diisi berdasarkan periode awal penarikan data
Declare @date2 date ='2025-06-30' -- diisi berdasarkan periode akhir penarikan data
Declare @iddc  int    = 1 -- diisi berdasarkan iddc

SELECT * FROM MB_InvMove_DC_Detail_view_v5_fc (@date1,@date2,@iddc);

/***********************************************************************************/

-- Query Inv. Movement Toko Detail - Mobeng
...
Select * from MB_InvMove_Toko_Detail_view_v5_fc (@date1,@date2,@kodestatustoko,@idcabang); 