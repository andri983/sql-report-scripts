...
Declare @date1		date	='2025-04-01'   -- periode awal data
Declare @date2		date    ='2025-04-30'   -- periode akhir data
Declare @iddc		int     =2				-- isi sesuai iddc data yg akan ditarik
...
Declare @bulan		int=5	    -- bulan penarikan Data
Declare @iddc		int=2		-- iddc disesuaikan dgn iddc data yang ditarik
...
and bulan=5				-- input sesuai Bulan perikan data
and kodestatustoko='R'  -- diganti berdasarkan kodestatustoko yg akan ditarik datanya.
and iddc=2				-- diganti berdasarkan iddc yg akan ditarik datanya.
...
--use MB_DC;
--use MB_DC_SBY;
Declare @date1 date = '2025-05-01'
Declare @date2 date = '2025-05-31'
Declare @iddc  int  = 2
...
--use MB_DC;
--use MB_DC_SBY;
Declare @date1 date = '2025-05-01'		-- diganti berdasarkan tanggal awal bulan penarikan data
Declare @date2 date = '2025-05-31'		-- diganti berdasarkan tanggal akhir bulan penarikan data
...
--GOOD, BOOK, BAD STOCK
/**************************************************************************************************/
Declare @date1 date	='2025-05-01'	-- diisi berdasarkan periode awal penarikan data
Declare @date2 date	='2025-05-31'	-- diisi berdasarkan periode Akhir penarikan data
...
EXEC sp_SMI_SOH_DC_byformula_per_jenisstok_view @date1,@date2,@iddc,@idjenisstok;
