    ...
    cte_transaksi AS (
        SELECT 
            ...
            CASE
                ...
                THEN 
					CASE
					    WHEN x.statusaccu LIKE 'RUSAK%' THEN (x.transactiondate::date + INTERVAL '28 days')::date -- 4 minggu
					    WHEN x.statusaccu LIKE 'LEMAH%' THEN (x.transactiondate::date + INTERVAL '112 days')::date -- 16 minggu
					END
                ELSE NULL
            END AS reminder2,
            0 as wa_status2,
