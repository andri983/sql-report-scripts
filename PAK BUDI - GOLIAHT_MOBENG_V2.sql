-----CREATE FOREIGN TABLE (select * from mb_rms01_mbho.SMIMstVoucherDiskon;)
...
CREATE FOREIGN TABLE mb_rms01_mbho.smimstvoucherpersen (
	idVoucher int8 OPTIONS(column_name 'idvoucher') NULL,
	idGroupVoucher int4 OPTIONS(column_name 'idgroupvoucher') NULL,
	kodeJenisVoucher bpchar(1) OPTIONS(column_name 'kodejenisvoucher') NULL,
	idMarchant int4 OPTIONS(column_name 'idmarchant') NULL,
	nomorSeriVoucher varchar(50) OPTIONS(column_name 'nomorserivoucher') NULL,
	tglAktif date OPTIONS(column_name 'tglaktif') NULL,
	tglAkhir date OPTIONS(column_name 'tglakhir') NULL,
...
SERVER mobeng_rms01
OPTIONS (schema_name 'dbo', table_name 'SMIMstVoucherPersen');	
...
--select * from public.mb_goliaht_voucher where statuskirim=0;
--update public.mb_goliaht_voucher set statuskirim=9 where statuskirim=0;
--select * from public.mb_trx_oil_goliaht_his;

--create table public.mb_goliaht_voucher_backup as
